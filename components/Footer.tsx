        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="h-7 w-7 rounded-lg bg-gradient-to-br from-blue-500 to-amber-500 flex items-center justify-center text-white font-bold text-xs">
                M
              </div>
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://x.com/mawlabs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MAW Labs on X"
                className="h-8 w-8 rounded-lg border border-white/8 bg-zinc-900 flex items-center justify-center text-zinc-500 hover:text-white hover:border-white/20 transition-colors"
              >
              ...
              <a
                href="https://linkedin.com/company/mawlabs"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MAW Labs on LinkedIn"
                className="h-8 w-8 rounded-lg border border-white/8 bg-zinc-900 flex items-center justify-center text-zinc-500 hover:text-white hover:border-white/20 transition-colors"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {services.map((s) => (
                <li key={s.href}>
                  <Link href={s.href} className="text-sm text-zinc-500 hover:text-white transition-colors">
                    {s.label}
                  </Link>
                </li>
              ))}
